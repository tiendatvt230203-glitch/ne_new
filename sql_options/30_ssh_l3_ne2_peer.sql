-- NE2 peer: SSH server leg (one policy, L3, src port 22).
--   192.168.182.2 -> 192.168.9.2, tcp, src 22 / dst ANY
-- Same policy db id + encryption_key as 30_ssh_l3_ne1.sql -> same wire policy_id.
...
VALUES (
    30,
    'ssh_l3_ne2_peer',
    'SSH L3 peer 192.168.182.2 -> 192.168.9.2 (tcp src 22)',
    FALSE, FALSE, FALSE,
    'seed'
);
